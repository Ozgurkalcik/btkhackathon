                          ...
                          children: [
                            ...
                            TextField(
                              ...
                              decoration: InputDecoration(
                                ...
                                labelStyle: TextStyle(color: AppColors.onSurfaceVariant),
                                prefixIcon: Icon(Icons.lock_clock_outlined, color: AppColors.onSurfaceVariant),
                                suffixIcon: IconButton(
                                  icon: Icon(
            ...
            Positioned(
              ...
              child: SafeArea(
                child: Container(
                  ...
                  child: IconButton(
                    icon: Icon(Icons.arrow_back_ios_new, color: AppColors.onSurface, size: sizes.sp(20)),
                    onPressed: () => Navigator.pop(context),
                  ),
                ),
              ),
